                    ...
                    <div className="flex-1 flex flex-col items-center justify-center p-6 sm:p-8 w-full md:w-[383px]">
                        <div className="flex flex-col gap-5 sm:gap-6 w-full max-w-sm">
                            ...
                            <button
                                ...
                                className="w-full min-h-[44px] px-4 py-3 bg-[#fddb32] rounded-lg flex items-center justify-center text-sm font-medium leading-5 text-[#191e3b] hover:bg-[#fddb32]/90 active:scale-[0.98] transition-transform"
                            >
                                Acessar plataforma
                            </button>
